...
async function main() {
  ...
  CID = [
    "ipfs://bafyreihrdz2ny6auwkaec7hqbb6av5oyw525ni6yedjkxt2mito27ekskq/metadata.json",
    "ipfs://bafyreibsrhrdmipyn5g4dwhqsdbbr4ygemm6xzr6brpeu4mtxxtuwbiuy4/metadata.json",
    "ipfs://bafyreihqmzkfv26ocsjy62ofws4uvagtz6jaihufqeyttdyxcc62yeisau/metadata.json",
    "ipfs://bafyreicoc2vctnstfdjbzlsqlqi3zurofn63cpazpjdlkh5bluknrzciu4/metadata.json",
    "ipfs://bafyreib7j3sqdjfay2xk27r76etur5rx5hu4pxoaxp3mgzn25nlacbzamm/metadata.json",
  ];

  // CREATE NFT WITH CUSTOM FEE
  let nftCreate = await new TokenCreateTransaction()
    .setTokenName("AP Collection 2")
    .setTokenSymbol("AP2")
  ...
  // let aliceKyc = await kycEnableFcn(aliceId); // Uses Token ID
